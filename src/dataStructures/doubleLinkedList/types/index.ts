...
export interface DoubleLinkedListInterface<T = unknown> {
  ...
  find: (params: FindParams<T>) => null | DoubleLinkedListNodeInterface<T>;
  deleteAll: (value?: T) => null | DoubleLinkedListNodeInterface<T>;
  delete: (value?: T) => null | DoubleLinkedListNodeInterface<T>;
  deleteNode: (node: DoubleLinkedListNodeInterface<T>) => DoubleLinkedListNodeInterface<T>;
  ...
  appendNode: (node: DoubleLinkedListNodeInterface<T>) => DoubleLinkedListNodeInterface<T>;
  prepend: (value: T) => DoubleLinkedListNodeInterface<T>;
  prependNode: (node: DoubleLinkedListNodeInterface<T>) => DoubleLinkedListNodeInterface<T>;
  has: (value?: T) => boolean;
  isEmpty: () => boolean;
  reverse: () => this;
  reverseBetween: () => this;

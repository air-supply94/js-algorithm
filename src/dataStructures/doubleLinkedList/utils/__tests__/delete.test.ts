...
test('doubleLinkedList deleteNode', () => {
  ...
  expect(deleteNode(linkedList, linkedList.head).value)
    .toBe(1);
  expect(linkedList.head.value)
    .toBe(3);
  expect(linkedList.tail.value)
  ...
  expect(deleteNode(linkedList, linkedList.tail).value)
    .toBe(4);
  expect(linkedList.head.value)
    .toBe(3);
  expect(linkedList.tail.value)
...
test('doubleLinkedList deleteValueBase', () => {
  ...
  expect(deleteValueBase(linkedList, 0, 4))
    .toBeNull();
  linkedList.append(0);
  linkedList.append(1);
  linkedList.append(1);
  linkedList.append(2);
  expect(deleteValueBase(linkedList, 1, 1).value)
    .toBe(1);
  linkedList.clear();
...
test('doubleLinkedList deleteIndex', () => {
  const linkedList = new DoubleLinkedList();
  expect(deleteIndex(linkedList, 0))
    .toBeNull();
  expect(deleteIndex(linkedList, -10))
    .toBeNull();
  ...
  expect(deleteIndex(linkedList, 10))
    .toBeNull();
  expect(deleteIndex(linkedList, -2).value)
    .toBe(2);
  expect(linkedList.size)
    .toBe(2);
  expect(linkedList.head.next.value)
  ...
  expect(linkedList.tail.previous.value)
    .toBe(1);
  expect(deleteIndex(linkedList, 1).value)
    .toBe(3);
  expect(deleteIndex(linkedList, 0).value)
    .toBe(1);
});

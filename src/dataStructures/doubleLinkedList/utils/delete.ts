...
export function deleteValueBase<T = unknown>(
...
export function deleteNode<T = unknown>(
  doubleLinkedList: interfaces.DoubleLinkedList<T>,
  node: interfaces.DoubleLinkedListNode<T>,
...
export function deleteIndex<T = unknown>(
  doubleLinkedList: interfaces.DoubleLinkedList<T>,
  index: number,
): interfaces.DoubleLinkedListNode<T> | null {
